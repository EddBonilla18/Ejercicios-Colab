...
mi_restaurante = Restaurant("la tia","mola")
mi_restaurante.describe_restaurant()
mi_restaurante = Restaurant("La pelos","Mexicana")
mi_restaurante.describe_restaurant()
mi_restaurante = Restaurant("Tacos","Quesadillas")
mi_restaurante.describe_restaurant()
...
Sixto = usuario("Orlando", "Bonilla", "BOMO060507", "2006","masculino","maestria")
...
mi_restaurante = Restaurant("la pelos","quesadillas")
mi_restaurante.describe_restaurant()
        ...
        while True :
            ...
            if cont=="quieropasar" :
                ...
                if self.intentosAcceso == 3:
                    ...
                    break
nnemalo = User('nene consentido','quieropasar')
nnemalo.ingresar()

class Heladeria(Restaurant):
    def _init_(self,nombre_restaurant,tipo_cocina):
        super()._init_(nombre_restaurant,tipo_cocina)
    sabores=['chocolate','galleta','nuez','queso','vainilla','pistache']
    def mostrar_sabores(self):
        sabores=['chocolate','galleta','nuez','queso','vainilla','pistache']
        print("tengo helados de "+sabores[0]+ "\n"+ sabores[1]+ "\n"+ sabores[2]+ "\n"+ sabores[3]+ "\n"+ sabores[4]+ "\n"+ sabores[5])
restaurante= Restaurant("EL gran frozy","helados")
restaurante.describe_restaurant()
ninopromedio= Heladeria("El gran frozy","helados")
